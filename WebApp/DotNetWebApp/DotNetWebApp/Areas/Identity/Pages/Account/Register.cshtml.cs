    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.YearOfGettingDriversLicence = Input.YearOfGettingDriversLicence;
                ...
                if (result.Succeeded)
                {
                    ...
                    // Generowanie tokenu do potwierdzenia e-maila
                    ...
                    // Wysyłanie tylko e-maila z potwierdzeniem e-maila
